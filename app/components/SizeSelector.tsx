...
export default function SizeSelector({
  ...
  const sizes = [
    {
      ...
      size: '42mm',
      price: 1150,
      frontImage: 'https://www.apple.com/newsroom/images/2024/09/introducing-apple-watch-series-10/article/Apple-Watch-Series-10-watch-face-Flux-240909_inline.jpg.large.jpg',
      sideImage: 'https://www.apple.com/newsroom/images/2024/09/introducing-apple-watch-series-10/article/Apple-Watch-Series-10-sideview-Flux-240909_inline.jpg.large.jpg',
    },
    {
      id: 2,
      size: '46mm',
      price: 1250,
      frontImage: 'https://rukminim2.flixcart.com/image/750/900/xif0q/smartwatch/j/m/6/-original-imah4jndaff8bgz7.jpeg?q=20&crop=false',
      sideImage: 'https://rukminim2.flixcart.com/image/750/900/xif0q/smartwatch/j/m/6/-original-imah4jndaff8bgz7-sideview.jpeg?q=20&crop=false',
    },
  ];
  ...
  return (
    <div className="flex flex-col items-center min-h-screen p-6 relative">
      ...
      {/* Size Selection and Image Display */}
      <div className="flex mb-4 space-x-6">
        {sizes.map((size) => (
          ...
          >
            <img
              src={view === 'front' ? size.frontImage : size.sideImage}
              alt={`${size.size} Watch Size`}
